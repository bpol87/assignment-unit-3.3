...
console.log('Original array is: ', supplyChanges);
...
console.log('Stretch positives array is: ', stretchPositives);
console.log('Stretch negatives array is: ', stretchNegatives);
console.log('Stretch zeroes array is: ', stretchZeroes);
console.log('Original array is: ', supplyChanges);
...
for (let item of supplyChanges){
totalParts = totalParts + item;
}
console.log('The total nubmer of parts is: ', totalParts);
...
console.log('Starting inventory of parts:', parts);
console.log('Each box can have 7 parts.');

while (parts >= 7) {
boxesFilled++;
parts = parts - 7;  
}
console.log('The number of boxes filled is: ', boxesFilled, 'boxes with ', parts, 'parts left over');
